...
public:
    ...
    static void nscript_auto(const google::protobuf::FileDescriptor* fileDescriptor, const std::string& axml)
    {
        ...
        m_stream << " // created at: " << ngl::tools::localtime::time2str() << std::endl;
        m_stream << std::endl;
...
namespace ngl
{
    ...
    static void nactor_auto_fun(const google::protobuf::FileDescriptor* fileDescriptor, const std::string& axml)
    {
        std::string ldata;
        {
            ...
            ngl::readfile lfile("../../public/cpp/actor/generated/auto/nactor_auto.h");
            lfile.read(ldata);
        }
        ...
        ngl::writefile lfile("../../public/cpp/actor/generated/auto/nactor_auto.h");
...
namespace ngl
{
	...
	public:
        ...
        m_stream2 << " // created at: " << ngl::tools::localtime::time2str() << std::endl;
...
namespace ngl
{
	void tdb::tdb_init(bool ainstance)
	{
        ...
        ngl::writefile lfile2("../../public/cpp/actor/generated/auto/nactor_auto_tdb.cpp");
        ...
        m_stream3 << R"(namespace ngl
{
	...
	void register_channel_db()
	{
        ...
        ngl::writefile lfile3("../../public/cpp/actor/generated/auto/register_channel_db.h");
...
{{
    ...
    static void create_actor()
    {
        ...
        std::set<std::string> lactorenumset;
        {
            ...
            ngl::readfile lfile("../../public/cpp/actor/actor_base/core/nactortype.h");
            std::string lnr;
            bool lbool = false;
