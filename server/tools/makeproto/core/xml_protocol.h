...
class xml_protocol
{
    ...
    static std::string logic_dir(std::string_view aname)
    {
        return std::format("../../public/cpp/actor/actor_logic/{}", aname);
    }
public:
    ...
    static void nscript_auto(const google::protobuf::FileDescriptor* fileDescriptor, const std::string& axml)
    {
        ...
        ngl::tools::writefile lfile(std::format("./nscript_{}.h", lnamespace).c_str());
        std::stringstream m_stream;
        m_stream << " // generated by makeproto, do not edit." << std::endl;
        m_stream << " // created at: " << ngl::tools::time::time2str() << std::endl;
        m_stream << std::endl;
        m_stream << "#pragma once" << std::endl;
        m_stream << "#include \"tools/serialize/ndefine.h\"" << std::endl;
        m_stream << "#include \"actor/generated/pb/example.pb.h\"" << std::endl;
        m_stream << "#include \"actor/generated/pb/net.pb.h\"" << std::endl;
        m_stream << "#include \"actor/generated/pb/db.pb.h\"" << std::endl;
        m_stream << std::endl;
    ...
    {
        ngl::tools::writefile lfile("./pbname_match.cpp");
...
namespace ngl
{
    ...
    {
        ngl::tools::writefile lfile("./pb_protocol.cpp");
        ...
        m_stream << "#include \"actor/actor_base/core/actor.h\"" << std::endl;
        m_stream << "#include \"actor/generated/pb/example.pb.h\"" << std::endl;
        m_stream << "#include \"actor/generated/pb/net.pb.h\"" << std::endl;
        m_stream << std::endl;
        m_stream << std::endl;
    ...
    static void nactor_auto_fun(const google::protobuf::FileDescriptor* fileDescriptor, const std::string& axml)
    {
        std::string ldata;
        {
            ...
            ngl::tools::readfile lfile("../../public/cpp/actor/generated/auto/nactor_auto.h");
            lfile.read(ldata);
        }
        ...
        ngl::tools::writefile lfile("../../public/cpp/actor/generated/auto/nactor_auto.h");
...
namespace ngl
{
	...
	void ndb_modular<ENUM, TDATA, TACTOR>::init_data()
	{
        ...
        for (const std::string& item : lset)
        {
            if (item == "actor_xxxx")
            {// Let playerconfirm
                m_stream << "\t// actor_xxxx placeholder requires manual update" << std::endl;
            }
	...
	public:
        ...
        m_stream2 << " // generated by makeproto, do not edit." << std::endl;
        m_stream2 << " // created at: " << ngl::tools::time::time2str() << std::endl;
        m_stream2 << R"(#include "actor/generated/auto/auto_actor_enum.h"
...
namespace ngl
{
	void tdb::tdb_init(bool ainstance)
	{
        ...
        ngl::tools::writefile lfile2("../../public/cpp/actor/generated/auto/nactor_auto_tdb.cpp");
        ...
        m_stream3 << R"(namespace ngl
{
	...
	void register_channel_db()
	{
        ...
        ngl::tools::writefile lfile3("../../public/cpp/actor/generated/auto/register_channel_db.h");
    ...
    static void enum_actor(std::string aenum)
    {
        ...
        std::string lpath = logic_dir(ltolower);
        ...
        ngl::tools::writefile lfileH(lpathH);
...
{{
	...
	public:
        ...
        ngl::tools::writefile lfileCPP(lpathCPP);
...
{{
    ...
    static void create_actor()
    {
        ...
        std::set<std::string> lactorenumset;
        {
            ...
            ngl::tools::readfile lfile("../../public/cpp/actor/actor_base/core/nactortype.h");
            std::string lnr;
            bool lbool = false;
        ...
        auto lfun = [&lhactorfilemap](const char* fname, const char* pbname)
            {
                ...
                ngl::tools::readfile lfile(lfilename);
                std::string lnr;
                std::string llastnr;
                bool lbool = false;
...

        {
            for (const std::string& item : lactorenumset)
            {
                ...
                {
                    std::string lactorhfile = std::format("{0}/{1}.h", logic_dir(lactortolower), lactortolower);
                    ngl::tools::readfile lfile(lactorhfile);
                ...
                {
                    std::string ldirectories = std::format("{}/message", logic_dir(lactortolower));
                    if (ngl::tools::directories_exists(ldirectories) == false)
                    {
                        ngl::tools::create_dir(ldirectories);
                    }
                    std::string lactorhfile = std::format("{0}/message/{1}_handle.cpp", logic_dir(lactortolower), lactortolower);

                    if (ngl::tools::file_exists(lactorhfile) == false)
                    {
                        ngl::tools::writefile lwfile(lactorhfile);
        ...
        for (const auto& item1 : lhactorfilemap)
        {
            ...
            // Readfile
            {
                ...
                std::string lactorfile = std::format("{0}/{1}.cpp", logic_dir(actorname), actorname);
                std::set<std::string> lset;
                {
                    ngl::tools::readfile lreadfile(lactorfile);
                    std::string lnr;
                ...
                if (!lcontent.empty() && !lset2.empty() && actorname != "actor_robot" && actorname != "actor_role")
                {
                    ...
                    ngl::tools::writefile lcppfile(lactorfile);
            ...
            {//g2c
                std::string lcontent;
                {
                    ngl::tools::readfile lreadfile("../../public/cpp/actor/actor_logic/nprotocol_g2c.cpp");
                    lreadfile.readcurrent(lcontent);
                }
		...
		>();
                ...
                lcontent += lend;
                ngl::tools::writefile lhfile("../../public/cpp/actor/actor_logic/nprotocol_g2c.cpp");
            ...
            {//c2g
                std::string lcontent;
                {
                    ngl::tools::readfile lreadfile("../../public/cpp/actor/actor_logic/nprotocol_c2g.cpp");
                    lreadfile.readcurrent(lcontent);
                }
                ngl::tools::replace("\r\n", "\n", lcontent, lcontent);
                ngl::tools::replace("\r", "\n", lcontent, lcontent);
                ...
                lcontent += lend;
                ngl::tools::writefile lhfile("../../public/cpp/actor/actor_logic/nprotocol_c2g.cpp");
                lhfile.write(lcontent);
            ...
            {
                   std::string lactorhfile = std::format("{0}/{1}.h", logic_dir(actorname), actorname);
                   ngl::tools::writefile lhfile(lactorhfile);
            ...
            {
                std::string lactorcppfile = std::format("{0}/message/{1}_handle.cpp", logic_dir(actorname), actorname);
                ngl::tools::writefile lcppfile(lactorcppfile);
