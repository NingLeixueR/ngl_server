...
## 项目简介
ngl_server 是一款基于 **Actor 模型** 的 C++ 游戏服务器框架，追求轻量、高效、易扩展。

## 依赖第三方库

### Conan 管理依赖
配置文件：[conanfile.py](https://github.com/NingLeixueR/ngl_server/blob/main/conanfile.py)
- **curl**
- **hiredis**
- **mysql-connector-c**
- **lua**
...
### 在CMake.CTest中引入了gtest用以单元测试

## 目录结构
- `ngl_server/public/cpp`：C++ 服务器公共头文件与源码
- `ngl_server/server`：项目核心服务实现
