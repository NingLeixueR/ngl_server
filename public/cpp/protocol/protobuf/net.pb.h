...
inline bool eplays_Parse(
    const std::string& name, eplays* value) {
...
inline bool ematching_cancel_stat_Parse(
    const std::string& name, ematching_cancel_stat* value) {
...
inline bool etype_matching_cancel_Parse(
    const std::string& name, etype_matching_cancel* value) {
...
inline bool ematching_confirm_stat_Parse(
    const std::string& name, ematching_confirm_stat* value) {
...
inline std::string* MATCHING_MEMBER::unsafe_arena_release_m_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:pbnet.MATCHING_MEMBER.m_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return m_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MATCHING_MEMBER::unsafe_arena_set_allocated_m_name(
    std::string* m_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (m_name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  m_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      m_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:pbnet.MATCHING_MEMBER.m_name)
}
