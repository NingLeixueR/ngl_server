...
namespace ngl
{
    ...
    std::string base64::base64_encode(std::uint8_t const* data, std::size_t len)
    {
        std::string dest;
    ...
    std::string base64::base64_encode(std::string const& s)
    {
    ...
    std::string base64::base64_decode(char const* data, std::size_t len)
    {
        std::string dest;
    ...
    std::string base64::base64_decode(std::string const& data)
    {
