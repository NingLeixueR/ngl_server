...
namespace ngl
{
	...
	public:
		...
		static ttab_matching& instance()
		{
			...
			{
				ncsv::loadcsv<ttab_matching>();
			}
			return *ncsv::get<ttab_matching>();
		}

		// # std::map<int, tab_matching>& tabs()
		// # tab_matching* tab(int aid)
	};
}//namespace ngl
