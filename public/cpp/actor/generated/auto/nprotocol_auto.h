...
namespace ngl
{
	...
	public:
		static void fun()
		{
			...
			/*200000058*/, np_login_request_info
			/*200000060*/, np_create_example
			/*200000062*/, np_example_entergame_ready
			/*200000064*/, np_example_actorid
			/*200000066*/, np_example_equit
			/*200000068*/, np_thruput_test
			/*200000070*/, np_operator_task
			/*200000072*/, np_operator_task_response
			/*200000074*/, np_get_rank
			/*200000076*/, np_get_rank_response
			/*200000078*/, np_activityrank_operator
			/*200000080*/, np_attribute_remove
			/*200000082*/, np_ukcp_waitrecv
		>();
		...
		tprotocol::tp_customs_script<
			...
			/*210000058*/, mforward<np_login_request_info>
			/*210000060*/, mforward<np_create_example>
			/*210000062*/, mforward<np_example_entergame_ready>
			/*210000064*/, mforward<np_example_actorid>
			/*210000066*/, mforward<np_example_equit>
			/*210000068*/, mforward<np_thruput_test>
			/*210000070*/, mforward<np_operator_task>
			/*210000072*/, mforward<np_operator_task_response>
			/*210000074*/, mforward<np_get_rank>
			/*210000076*/, mforward<np_get_rank_response>
			/*210000078*/, mforward<np_activityrank_operator>
			/*210000080*/, mforward<np_attribute_remove>
			/*210000082*/, mforward<np_ukcp_waitrecv>
		>();
		}
	};
}//namespace ngl
