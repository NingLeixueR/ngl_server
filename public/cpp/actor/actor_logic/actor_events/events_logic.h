...
namespace ngl
{
	...
	public:
		...
		dprotocoljson(np_eevents_logic_rolelogin, m_type, m_actorid)
	};
	...
	public:
		...
		i64_actorid m_actorid;
		dprotocoljson(np_eevents_logic_roleoffline, m_type, m_actorid)
	};
	...
	public:
		...
		int32_t m_nowvalue;
		dprotocoljson(np_eevents_logic_rolevaluechange, m_type, m_actorid, m_beforevalue, m_nowvalue)
	};
